...
int main() {
    ...
    if(flag) {
        ...
        printf("\n\n====>\tHere we see that binary search is more efficient than linear. But the condition is if we want to apply binary serch the Given data must be shorted.\n\n");
    }
